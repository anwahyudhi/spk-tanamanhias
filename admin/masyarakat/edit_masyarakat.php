...
$id = $_GET['dia'];
$query=mysqli_query($dbh,"select * from pengguna where id_pengguna='$id'");
  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column nav-pills">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../tanaman/data-tanaman.php">
              <span data-feather="users" class="align-text-bottom"></span>
              Data Tanaman
            </a>
          </li>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Edit Data Masyarakat</h1>
        
      </div>
     <form class="form" action="proses_edit_masyarakat.php?dia=<?php echo $data['id_pengguna'] ?>" method="POST" enctype="multipart/form-data">
                    
                    <div class="form-group">
                      <label>Nama</label>
                      <input type="text" name="nama" class="form-control" value="<?php echo $data['nama_pengguna'] ?>">
                    </div>

                    <div class="form-group">
                      <label>Alamat</label>
                      <textarea name="alamat" class="form-control"><?php echo $data['alamat_pengguna'];?></textarea> 
                    </div>
            ...
            <div class="form-group">
              ...
              <input type="submit" required name="nanam" value = "Simpan" class="btn btn-success btn-fill pull-left" onclick="return confirm('Apa anda yakin dengan perubahan data akun masyarakat?');">
        </div>
                  </form>
