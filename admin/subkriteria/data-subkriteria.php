     ...
     <div class="panel">
        ...
        <table class="table table-hover table-bordered">
          <thead>
            <tr>
              <th scope="col">No</th>
              <th scope="col">Nama Subriteria</th>
          ...
          <tbody>
            <?php 
            $i = 1;
            $sql = "SELECT * FROM subkriteria where id_kriteria = '$data[id_kriteria]'";
            foreach ($dbh->query($sql) as $datan) :
            ?>
            <tr>
            	<td><?php echo $i ?></td>
            	<td><?php echo $datan['nama_subkriteria'] ?></td>
            	
            	<td><?php echo $datan['nilai_subkriteria'] ?></td>
            	<td>
              	<a href="ubah_subkriteria.php?subkriteria=<?php echo $datan['id_subkriteria'] ?>" class="btn btn-warning btn-sm btn-fill btn-block"><span>ubah</span>
            	</a>   
