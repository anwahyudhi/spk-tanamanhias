  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Ubah Data Kriteria</h1>
        
      </div>

      <form class="form" action="proses_ubah_kriteria.php?kriteria=<?php echo $data['id_kriteria'] ?>" method="POST" enctype="multipart/form-data">
