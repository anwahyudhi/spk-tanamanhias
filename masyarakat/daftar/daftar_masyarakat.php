...
<body>
    ...
    <div class="login-clean">
        <form method="post" action="proses_daftar.php">
            <center>
            <h2 class="h3">Daftar Akun</h2>
            	
            </center>
            <br>
            <div class="form-group">
            	<h5 class="h5">Username</h5>
            	<input class="form-control" placeholder="Masukkan username" name="username" type="username" required ></div>

            <div class="form-group">
            	<h5 class="h5">Nama</h5>
            	<input class="form-control" placeholder="Masukkan Nama" name="nama" required ></div>
            ...
            <div class="form-group">
            	...
            	<input class="form-control" placeholder="masukkan Password" name="password" type="password" required ></div>

            <div class="form-group">
                <button class="btn btn-success btn-block" name="daftar" id="daftar" type="submit">Daftar</button>
            </div>
        </form>
</div>
