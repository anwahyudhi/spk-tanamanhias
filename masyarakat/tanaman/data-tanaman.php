...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column nav-pills">
               <li class="nav-item">
            <a class="nav-link" aria-current="page" href="../index-masyarakat.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
     ...
     <a href="tambah_tanaman.php" class="btn btn-success btn-fill">
        ...
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              ...
              <th scope="col">Tinggi Tanaman</th>
              <th scope="col">Pencahayaan</th>
          ...
          <tbody>
            ...
            <tr>
            	...
            	<td>
              <a href="edit_tanaman.php?tanaman=<?php echo $data['id_tanaman'] ?>" class="btn btn-warning btn-sm btn-fill btn-block">
			    <span>Ubah</span>
            	</a>   
              <a class="btn btn-danger btn-sm btn-fill btn-block" href="hapus_tanaman.php?id=<?php echo $data['id_tanaman'] ?>" onclick="return confirm('Apa anda yakin dengan penghapusan data ?');"><span>Hapus</span>
              </a>
